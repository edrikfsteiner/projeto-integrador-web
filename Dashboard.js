...
import SellIcon from '@mui/icons-material/MonetizationOn'; // Importando o ícone de vendas
...
import SalesSystem from '../Vendas/SalesSystem'; // Importando o sistema de vendas
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box sx={{ flexGrow: 1, p: 3 }}>
        ...
        {currentPage === 'Vendas' && <SalesSystem />} {/* Adicionando o sistema de vendas */}
        ...
        {currentPage === 'Relatorio' && <ReportPage items={items} contacts={contacts} clients={clients} />}
      </Box>
